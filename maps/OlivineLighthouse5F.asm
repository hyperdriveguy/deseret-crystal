OlivineLighthouse5F_MapScriptHeader:
	...
	def_warp_events
	warp_event  9, 15, OLIVINE_MOUNT_TIMPANOGOS_6F, 1
	warp_event  3,  5, OLIVINE_MOUNT_TIMPANOGOS_4F, 2
	warp_event  9,  7, OLIVINE_MOUNT_TIMPANOGOS_4F, 3
	warp_event 16,  7, OLIVINE_MOUNT_TIMPANOGOS_4F, 9
	warp_event 17,  7, OLIVINE_MOUNT_TIMPANOGOS_4F, 10
	warp_event 16,  5, OLIVINE_MOUNT_TIMPANOGOS_6F, 2
	warp_event 17,  5, OLIVINE_MOUNT_TIMPANOGOS_6F, 3

	def_coord_events

	def_bg_events
	bg_event  3, 13, BGEVENT_ITEM + HYPER_POTION, EVENT_OLIVINE_MOUNT_TIMPANOGOS_5F_HIDDEN_HYPER_POTION
	...
	itemball_event 15, 12, RARE_CANDY, 1, EVENT_OLIVINE_MOUNT_TIMPANOGOS_5F_RARE_CANDY
	itemball_event  6, 15, SUPER_REPEL, 1, EVENT_OLIVINE_MOUNT_TIMPANOGOS_5F_SUPER_REPEL
	tmhmball_event  2, 13, TM_ENERGY_BALL, EVENT_OLIVINE_MOUNT_TIMPANOGOS_5F_TM_ENERGY_BALL
