...
MahoganyGymPryceScript:
	...
	setflag ENGINE_ROCKETS_IN_SALT_LAKE_VALLEY
	setevent EVENT_ROUTE_55_CIVILIANS
	setevent EVENT_SALT_LAKE_VALLEY_BLACKBELT_BLOCKS_STAIRS
	clearevent EVENT_ROUTE_55_ROCKET_SCOUT
	clearevent EVENT_SALT_LAKE_VALLEY_ROCKET_TAKEOVER
	clearevent EVENT_USED_THE_CARD_KEY_IN_THE_SALT_LAKE_VALLEY
