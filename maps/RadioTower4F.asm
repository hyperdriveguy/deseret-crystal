RadioTower4F_MapScriptHeader:
	...
	def_warp_events
	warp_event  0,  0, SALT_LAKE_VALLEY_5F, 1
	warp_event  9,  0, SALT_LAKE_VALLEY_3F, 2
	warp_event 12,  0, SALT_LAKE_VALLEY_5F, 2
	warp_event 17,  0, SALT_LAKE_VALLEY_3F, 3
	...
	def_object_events
	object_event  5,  6, SPRITE_ROCKET, SPRITEMOVEDATA_SPINCLOCKWISE, 0, 0, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 3, GenericTrainerGruntM10, EVENT_SALT_LAKE_VALLEY_ROCKET_TAKEOVER
	object_event  6,  4, SPRITE_FAT_GUY, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_COMMAND, jumptextfaceplayer, RadioTower4FFisherText, EVENT_SALT_LAKE_VALLEY_CIVILIANS_AFTER
	...
	object_event 14,  1, SPRITE_PROTON, SPRITEMOVEDATA_STANDING_LEFT, 0, 2, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 2, GenericTrainerProton1, EVENT_SALT_LAKE_VALLEY_ROCKET_TAKEOVER
	object_event 12,  4, SPRITE_ROCKET_GIRL, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 1, GenericTrainerGruntF4, EVENT_SALT_LAKE_VALLEY_ROCKET_TAKEOVER
	object_event  4,  2, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 4, GenericTrainerRocketScientistRich, EVENT_SALT_LAKE_VALLEY_ROCKET_TAKEOVER
