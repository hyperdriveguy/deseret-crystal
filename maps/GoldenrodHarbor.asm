GoldenrodHarbor_MapScriptHeader:
	...
	def_warp_events
	warp_event 31, 16, MILLCREEK_CANYON_GATE, 1
	warp_event 31, 17, MILLCREEK_CANYON_GATE, 2
	...
	bg_event 22, 21, BGEVENT_ITEM + REVIVE, EVENT_MILLCREEK_CANYON_HIDDEN_REVIVE
	...
	itemball_event 13,  3, STAR_PIECE, 1, EVENT_MILLCREEK_CANYON_STAR_PIECE
	object_event 27, 15, SPRITE_ACE_TRAINER_F, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_COMMAND, pokemart, MARTTYPE_ADVENTURER, MART_MILLCREEK_CANYON, -1
	...
	object_event 40, 16, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_ROUTE_55_ROCKET_SCOUT
