OlivineCity_MapScriptHeader:
	...
	warp_event 33, 19, OLIVINE_MOUNT_TIMPANOGOS_1F, 1
	warp_event 19, 31, OLIVINE_PORT_PASSAGE, 1
	warp_event 20, 31, OLIVINE_PORT_PASSAGE, 2
	warp_event 57, 30, TOOLE_CITY_WENDOVER_CITY_GATE, 5
	warp_event 57, 31, TOOLE_CITY_WENDOVER_CITY_GATE, 6
	...
	bg_event 36, 14, BGEVENT_ITEM + RARE_CANDY, EVENT_UTAH_POINT_HIDDEN_RARE_CANDY
	bg_event 47, 17, BGEVENT_ITEM + BIG_PEARL, EVENT_UTAH_POINT_HIDDEN_BIG_PEARL
	bg_event 49, 29, BGEVENT_ITEM + SOFT_SAND, EVENT_UTAH_POINT_HIDDEN_SOFT_SAND

	def_object_events
	object_event 10,  7, SPRITE_SILVER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_RIVAL_UTAH_POINT
