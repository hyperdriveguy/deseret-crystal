Route30_MapScriptHeader:
	...
	def_warp_events
	warp_event  7, 39, MTC_CAMPUS_BERRY_SPEECH_HOUSE, 1
	...
	bg_event 14,  9, BGEVENT_ITEM + POTION, EVENT_MTC_CAMPUS_HIDDEN_POTION
	bg_event  5, 39, BGEVENT_JUMPTEXT, BerryMastersHouseSignText

	def_object_events
	object_event  5, 26, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, YoungsterJoey_ImportantBattleScript, EVENT_MTC_CAMPUS_BATTLE
	object_event  5, 24, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, PIDGEY, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_MTC_CAMPUS_BATTLE
	object_event  5, 25, SPRITE_RATTATA_BACK, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_MTC_CAMPUS_BATTLE
	object_event  2, 28, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerYoungsterJoey, EVENT_MTC_CAMPUS_YOUNGSTER_JOEY
	...
	cuttree_event  8,  6, EVENT_MTC_CAMPUS_CUT_TREE
	fruittree_event 10, 39, FRUITTREE_MTC_CAMPUS_1, ORAN_BERRY, PAL_NPC_BLUE
	fruittree_event 11,  5, FRUITTREE_MTC_CAMPUS_2, PECHA_BERRY, PAL_NPC_RED
	itemball_event  8, 35, ANTIDOTE, 1, EVENT_MTC_CAMPUS_ANTIDOTE
