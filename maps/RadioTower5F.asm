RadioTower5F_MapScriptHeader:
	...
	def_warp_events
	warp_event  0,  0, SALT_LAKE_VALLEY_4F, 1
	warp_event 12,  0, SALT_LAKE_VALLEY_4F, 3
	...
	def_object_events
	object_event  3,  6, SPRITE_GENTLEMAN, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, RadioTower5FDirectorText, EVENT_SALT_LAKE_VALLEY_DIRECTOR
	object_event  0,  4, SPRITE_PETREL, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Petrel1Script, EVENT_SALT_LAKE_VALLEY_PETREL
	object_event 13,  5, SPRITE_ARCHER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_SALT_LAKE_VALLEY_ROCKET_TAKEOVER
	object_event 17,  2, SPRITE_ARIANA, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 1, GenericTrainerAriana1, EVENT_SALT_LAKE_VALLEY_ROCKET_TAKEOVER
	object_event 13,  5, SPRITE_ROCKER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, BenText, EVENT_SALT_LAKE_VALLEY_CIVILIANS_AFTER
	itemball_event  8,  5, ULTRA_BALL, 1, EVENT_SALT_LAKE_VALLEY_5F_ULTRA_BALL
...
RadioTower5FRocketBossTrigger:
	...
	setevent EVENT_CLEARED_SALT_LAKE_VALLEY
	clearflag ENGINE_ROCKETS_IN_SALT_LAKE_VALLEY
	setevent EVENT_ROUTE_55_ROCKET_SCOUT
	setevent EVENT_ROUTE_55_ROCKET_TAKEOVER
	setevent EVENT_SALT_LAKE_VALLEY_ROCKET_TAKEOVER
	clearevent EVENT_MAHOGANY_MART_OWNERS
	clearflag ENGINE_ROCKETS_IN_MAHOGANY
	clearevent EVENT_ROUTE_55_CIVILIANS
	clearevent EVENT_SALT_LAKE_VALLEY_CIVILIANS_AFTER
