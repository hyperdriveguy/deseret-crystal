UnionCaveB1FNorth_MapScriptHeader:
	...
	def_warp_events
	warp_event  3,  3, PROVO_CANYON_OUTSIDE, 7
	warp_event  3, 11, PROVO_CANYON_OUTSIDE, 8
	warp_event 15, 23, ROUTE_US40_1F, 1

	def_coord_events

	def_bg_events
	bg_event 11, 23, BGEVENT_ITEM + X_SPEED, EVENT_ROUTE_US40_B1F_NORTH_HIDDEN_X_SPEED
	bg_event 13,  4, BGEVENT_ITEM + REVIVE, EVENT_ROUTE_US40_B1F_NORTH_HIDDEN_REVIVE
	...
	tmhmball_event  5, 22, TM_SWIFT, EVENT_ROUTE_US40_B1F_NORTH_TM_SWIFT
	itemball_event 17, 21, X_DEFEND, 1, EVENT_ROUTE_US40_B1F_NORTH_X_DEFEND
