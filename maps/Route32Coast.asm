Route32Coast_MapScriptHeader:
	...
	def_warp_events
	warp_event  4, 57, ROUTE_US40_B1F_SOUTH, 4
	warp_event 17, 51, HEBER_CITY_HOUSE, 1
	...
	bg_event 17, 34, BGEVENT_ITEM + LEVEL_BALL, EVENT_HEBER_CITY_HIDDEN_LEVEL_BALL
	bg_event  5, 45, BGEVENT_ITEM + HYPER_POTION, EVENT_HEBER_CITY_HIDDEN_HYPER_POTION
	bg_event 14,  8, BGEVENT_ITEM + HYPER_POTION, EVENT_HEBER_CITY_HIDDEN_ELIXIR
	...
	fruittree_event 21, 51, FRUITTREE_HEBER_CITY, ASPEAR_BERRY, PAL_NPC_BROWN
	itemball_event  5, 18, WHITE_HERB, 1, EVENT_HEBER_CITY_WHITE_HERB
	itemball_event 22, 63, SOFT_SAND, 1, EVENT_HEBER_CITY_SOFT_SAND
