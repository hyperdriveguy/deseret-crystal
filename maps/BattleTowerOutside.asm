BattleTowerOutside_MapScriptHeader:
	...
	def_warp_events
	warp_event  8, 21, TIMPANOGOS_CAVE_ROUTE_67_GATE, 3
	warp_event  9, 21, TIMPANOGOS_CAVE_ROUTE_67_GATE, 4
	warp_event  8,  9, ROUTE_67_1F, 1 ; hole
	warp_event  9,  9, ROUTE_67_1F, 2 ; hole
	...
	object_event 12, 18, SPRITE_SAILOR, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 0, 1, -1, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, BattleTowerOutsideSailorText, EVENT_ROUTE_67_CLOSED
	object_event 12, 24, SPRITE_PICNICKER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, -1
	object_event  8,  9, SPRITE_RATTATA_BACK, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptext, BattleTowerOutsideDoorsClosedText, EVENT_ROUTE_67_OPEN
	object_event  9,  9, SPRITE_RATTATA_BACK, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptext, BattleTowerOutsideDoorsClosedText, EVENT_ROUTE_67_OPEN
...
BattleTowerOutsidePanUpTrigger1:
	...
	warpfacing UP, ROUTE_67_1F, 10, 15
	end

BattleTowerOutsidePanUpTrigger2:
	scall BattleTowerOutsidePanUpHelperScript
	warpfacing UP, ROUTE_67_1F, 11, 15
	end
