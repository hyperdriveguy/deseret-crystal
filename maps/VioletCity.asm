VioletCity_MapScriptHeader:
	...
	warp_event 23,  5, OREM_CITY_1F, 1
	warp_event 39, 28, BYU_UNDERGROUND_VIOLET_GATE, 1
	warp_event 39, 29, BYU_UNDERGROUND_VIOLET_GATE, 2
	warp_event  2, 12, SALT_LAKE_CITY_VIOLET_GATE, 3
	warp_event  2, 13, SALT_LAKE_CITY_VIOLET_GATE, 4
	...
	bg_event 37, 18, BGEVENT_ITEM + HYPER_POTION, EVENT_UTAH_LAKE_HIDDEN_HYPER_POTION
	bg_event 21, 13, BGEVENT_ITEM + POKE_BALL, EVENT_UTAH_LAKE_HIDDEN_POKE_BALL

	def_object_events
	object_event 13, 20, SPRITE_FAT_GUY, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, VioletCityEarlScript, EVENT_UTAH_LAKE_EARL
	...
	cuttree_event 36, 23, EVENT_UTAH_LAKE_CUT_TREE
	fruittree_event 14, 33, FRUITTREE_UTAH_LAKE, CHERI_BERRY, PAL_NPC_RED
	itemball_event 10,  6, PP_UP, 1, EVENT_UTAH_LAKE_PP_UP
	itemball_event 35, 12, RARE_CANDY, 1, EVENT_UTAH_LAKE_RARE_CANDY
