MurkySwamp_MapScriptHeader:
	...
	def_warp_events
	warp_event  7, 35, CARBON_ROAD, 1
	warp_event  8, 35, CARBON_ROAD, 2
	warp_event 36,  5, ROUTE_US40_B1F_SOUTH, 3

	def_coord_events

	def_bg_events
	bg_event 20, 10, BGEVENT_ITEM + MULCH, EVENT_PRICE_CITY_HIDDEN_MULCH
	bg_event 22, 13, BGEVENT_ITEM + X_SPCL_DEF, EVENT_PRICE_CITY_HIDDEN_X_SPCL_DEF
	bg_event  5, 23, BGEVENT_ITEM + BIG_MUSHROOM, EVENT_PRICE_CITY_HIDDEN_BIG_MUSHROOM
	bg_event 40, 33, BGEVENT_ITEM + TINYMUSHROOM, EVENT_PRICE_CITY_HIDDEN_TINYMUSHROOM

	def_object_events
	object_event 40, 26, SPRITE_CHERYL, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, MurkySwampCherylScript, EVENT_PRICE_CITY_CHERYL
	...
	itemball_event 14,  9, FULL_HEAL, 1, EVENT_PRICE_CITY_FULL_HEAL
	itemball_event 10, 11, BIG_MUSHROOM, 1, EVENT_PRICE_CITY_BIG_MUSHROOM
	itemball_event 43, 23, TOXIC_ORB, 1, EVENT_PRICE_CITY_TOXIC_ORB
	itemball_event 14, 34, MULCH, 1, EVENT_PRICE_CITY_MULCH
	cuttree_event  2, 14, EVENT_PRICE_CITY_CUT_TREE_1
	cuttree_event  6, 19, EVENT_PRICE_CITY_CUT_TREE_2
...
.Beaten
	...
	clearevent EVENT_ROUTE_67_CHERYL
	end
