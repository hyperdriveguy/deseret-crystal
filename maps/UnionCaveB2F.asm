UnionCaveB2F_MapScriptHeader:
	...
	def_warp_events
	warp_event  5,  3, ROUTE_US40_B1F_SOUTH, 2

	def_coord_events

	def_bg_events
	bg_event  4, 11, BGEVENT_ITEM + CALCIUM, EVENT_ROUTE_US40_B2F_HIDDEN_CALCIUM
	bg_event  2, 25, BGEVENT_ITEM + ULTRA_BALL, EVENT_ROUTE_US40_B2F_HIDDEN_ULTRA_BALL

	def_object_events
	object_event 11, 31, SPRITE_LAPRAS, SPRITEMOVEDATA_SWIM_AROUND, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, UnionCaveLapras, EVENT_ROUTE_US40_B2F_LAPRAS
	...
	itemball_event 16,  2, ELIXIR, 1, EVENT_ROUTE_US40_B2F_ELIXIR
	itemball_event 12, 19, HYPER_POTION, 1, EVENT_ROUTE_US40_B2F_HYPER_POTION

	object_const_def
	const UNIONCAVEB2F_LAPRAS

UnionCaveB2FLapras:
	checkflag ENGINE_ROUTE_US40_LAPRAS
	iftrue .NoAppear
	readvar VAR_WEEKDAY
...
UnionCaveLapras:
	...
	startbattle
	disappear UNIONCAVEB2F_LAPRAS
	setflag ENGINE_ROUTE_US40_LAPRAS
