IlexForest_MapScriptHeader:
	...
	def_warp_events
	warp_event  3,  7, ROUTE_191_EXCAVATION_SITE_GATE, 3
	warp_event  5, 44, EXCAVATION_SITE_AZALEA_GATE, 1
	warp_event  5, 45, EXCAVATION_SITE_AZALEA_GATE, 2
	...
	bg_event 13,  9, BGEVENT_ITEM + ETHER, EVENT_EXCAVATION_SITE_HIDDEN_ETHER
	bg_event 24, 16, BGEVENT_ITEM + SUPER_POTION, EVENT_EXCAVATION_SITE_HIDDEN_SUPER_POTION
	bg_event  3, 19, BGEVENT_ITEM + FULL_HEAL, EVENT_EXCAVATION_SITE_HIDDEN_FULL_HEAL
	bg_event 20,  9, BGEVENT_JUMPTEXT, Text_IlexForestMossRock
	bg_event 10, 24, BGEVENT_UP, MapIlexForestSignpost4Script
	bg_event 25, 24, BGEVENT_ITEM + SILVER_LEAF, EVENT_EXCAVATION_SITE_HIDDEN_SILVER_LEAF_1
	bg_event 19,  8, BGEVENT_ITEM + SILVER_LEAF, EVENT_EXCAVATION_SITE_HIDDEN_SILVER_LEAF_2
	bg_event 25, 23, BGEVENT_JUMPSTD, treegrotto, HIDDENGROTTO_EXCAVATION_SITE
	bg_event 26, 23, BGEVENT_JUMPSTD, treegrotto, HIDDENGROTTO_EXCAVATION_SITE

	def_object_events
	object_event 16, 33, SPRITE_FARFETCH_D, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, IlexForestFarfetchdScript, EVENT_EXCAVATION_SITE_FARFETCHD
	object_event  7, 30, SPRITE_BLACK_BELT, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, IlexForestCharcoalMasterScript, EVENT_EXCAVATION_SITE_CHARCOAL_MASTER
	object_event 10, 31, SPRITE_KURT, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_EXCAVATION_SITE_KURT
	object_event  5, 26, SPRITE_PICNICKER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, Text_IlexForestLass, EVENT_EXCAVATION_SITE_LASS
	object_event 10, 26, SPRITE_CELEBI, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_EXCAVATION_SITE_CELEBI
	object_event  9, 25, SPRITE_LYRA, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, IlexForestLyraScript, EVENT_EXCAVATION_SITE_LYRA
	object_event  9, 30, SPRITE_SCHOOLBOY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, IlexForestCharcoalApprenticeScript, EVENT_EXCAVATION_SITE_APPRENTICE
	...
	cuttree_event 10, 27, EVENT_EXCAVATION_SITE_CUT_TREE
	itemball_event 22, 34, REVIVE, 1, EVENT_EXCAVATION_SITE_REVIVE
	itemball_event 11, 19, X_ATTACK, 1, EVENT_EXCAVATION_SITE_X_ATTACK
	itemball_event 25, 17, ANTIDOTE, 1, EVENT_EXCAVATION_SITE_ANTIDOTE
	itemball_event 29,  3, MULCH, 1, EVENT_EXCAVATION_SITE_MULCH
...
IlexForestCharcoalMasterScript:
	...
	waitbutton
	closetext
	setevent EVENT_EXCAVATION_SITE_FARFETCHD
	setevent EVENT_EXCAVATION_SITE_APPRENTICE
	setevent EVENT_EXCAVATION_SITE_CHARCOAL_MASTER
...
.CelebiEvent:
	...
	setevent EVENT_ROUTE_87_KURT
	disappear ILEXFOREST_LASS
	clearevent EVENT_ROUTE_191_EXCAVATION_SITE_GATE_LASS
