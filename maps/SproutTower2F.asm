SproutTower2F_MapScriptHeader:
	...
	def_warp_events
	warp_event  4,  4, OREM_CITY_1F, 3
	warp_event  0,  6, OREM_CITY_1F, 4
	warp_event 15,  3, OREM_CITY_1F, 5
	warp_event  8, 14, OREM_CITY_3F, 1
	...
	itemball_event  1,  1, X_ACCURACY, 1, EVENT_OREM_CITY2F_X_ACCURACY
