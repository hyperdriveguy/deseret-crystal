BurnedTowerB1F_MapScriptHeader:
	...
	def_warp_events
	warp_event 10,  9, PARK_CITY_1F, 3 ; hole
	warp_event  7, 15, PARK_CITY_1F, 4
	...
	def_object_events
	object_event  7,  3, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, RAIKOU, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_PARK_CITY_B1F_BEASTS_1
	object_event 12,  3, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, ENTEI, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_PARK_CITY_B1F_BEASTS_1
	object_event 10,  4, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, SUICUNE, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_PARK_CITY_B1F_BEASTS_1
	object_event  7,  3, SPRITE_MON_ICON, SPRITEMOVEDATA_STILL, 0, RAIKOU, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_PARK_CITY_B1F_BEASTS_2
	object_event 12,  3, SPRITE_MON_ICON, SPRITEMOVEDATA_STILL, 0, ENTEI, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_PARK_CITY_B1F_BEASTS_2
	object_event 10,  4, SPRITE_MON_ICON, SPRITEMOVEDATA_STILL, 0, SUICUNE, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_PARK_CITY_B1F_BEASTS_2
	object_event 10, 12, SPRITE_EUSINE, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BurnedTowerB1FEusine, EVENT_EUSINE_IN_PARK_CITY
	strengthboulder_event 17, 8
	tmhmball_event 16,  4, TM_FLAME_CHARGE, EVENT_PARK_CITY_B1F_TM_FLAME_CHARGE
...
ReleaseTheBeasts:
	...
	clearevent EVENT_ANTELOPE_ISLAND_GRAMPS
	setevent EVENT_PARK_CITY_MORTY
	setevent EVENT_PARK_CITY_1F_EUSINE
