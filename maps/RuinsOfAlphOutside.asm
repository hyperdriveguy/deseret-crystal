RuinsOfAlphOutside_MapScriptHeader:
	...
	def_warp_events
	warp_event  4, 23, PROVO_CANYON_HO_OH_CHAMBER, 1
	warp_event 16, 13, PROVO_CANYON_KABUTO_CHAMBER, 1
	warp_event  4, 35, PROVO_CANYON_OMANYTE_CHAMBER, 1
	warp_event 18, 39, PROVO_CANYON_AERODACTYL_CHAMBER, 1
	warp_event 12, 19, PROVO_CANYON_ENTRANCE_CHAMBER, 1
	warp_event 19, 17, PROVO_CANYON_RESEARCH_CENTER, 1
	warp_event  8, 25, ROUTE_US40_B1F_NORTH, 1
	warp_event  8, 33, ROUTE_US40_B1F_NORTH, 2
	warp_event  3,  5, SALT_LAKE_CITY_PROVO_CANYON_GATE, 3
	warp_event 15, 26, TIMPANOGOS_PASS_PROVO_CANYON_GATE, 1
	warp_event 15, 27, TIMPANOGOS_PASS_PROVO_CANYON_GATE, 2
	warp_event 10,  9, PROVO_CANYON_SINJOH_CHAMBER, 1
	...
	bg_event  4, 13, BGEVENT_ITEM + RARE_CANDY, EVENT_PROVO_CANYON_OUTSIDE_HIDDEN_RARE_CANDY

	def_object_events
	object_event 13, 21, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideScientistScript, EVENT_PROVO_CANYON_OUTSIDE_SCIENTIST
	object_event 18, 18, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_PROVO_CANYON_OUTSIDE_SCIENTIST_CLIMAX
	...
	object_event 15, 23, SPRITE_FISHER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideFisherScript, EVENT_PROVO_CANYON_OUTSIDE_TOURIST_FISHER
	object_event 14, 14, SPRITE_SCHOOLBOY, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideYoungster2Script, EVENT_PROVO_CANYON_OUTSIDE_TOURIST_YOUNGSTERS
	object_event 16, 17, SPRITE_SCHOOLBOY, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideYoungster1Script, EVENT_PROVO_CANYON_OUTSIDE_TOURIST_YOUNGSTERS
...
RuinsofAlphOutsideTrigger0:
	checkevent EVENT_DO_PROVO_CANYON_CLIMAX
	iffalse .End
	...
	clearevent EVENT_DO_PROVO_CANYON_CLIMAX
	setevent EVENT_PROVO_CANYON_CLIMAX_DONE
.End
	end
...
RuinsOfAlphOutsideScientistScript:
	...
	setmapscene PROVO_CANYON_RESEARCH_CENTER, $1
	warpcheck
	end
