Route37_MapScriptHeader:
	...
	bg_event  4,  2, BGEVENT_ITEM + ETHER, EVENT_TEMPLE_SQUARE_HIDDEN_ETHER

	def_object_events
	object_event 16,  8, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SunnyScript, EVENT_TEMPLE_SQUARE_SUNNY_OF_SUNDAY
	...
	fruittree_event 13,  5, FRUITTREE_TEMPLE_SQUARE_1, RED_APRICORN, PAL_NPC_RED
	fruittree_event 16,  5, FRUITTREE_TEMPLE_SQUARE_2, BLU_APRICORN, PAL_NPC_BLUE
	fruittree_event 15,  7, FRUITTREE_TEMPLE_SQUARE_3, BLK_APRICORN, PAL_NPC_PURPLE
