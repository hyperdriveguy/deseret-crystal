Route40BattleTowerGate_MapScriptHeader:
	...
	def_warp_events
	warp_event  4,  7, TIMPANOGOS_CAVE, 1
	warp_event  5,  7, TIMPANOGOS_CAVE, 1
	warp_event  4,  0, ROUTE_67_OUTSIDE, 1
	warp_event  5,  0, ROUTE_67_OUTSIDE, 2
	...
	def_object_events
	object_event  0,  4, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_COMMAND, jumptextfaceplayer, Route40BattleTowerGateOfficer, EVENT_ROUTE_67_CLOSED
