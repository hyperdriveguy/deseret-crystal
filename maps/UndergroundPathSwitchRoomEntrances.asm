UndergroundPathSwitchRoomEntrances_MapScriptHeader:
	...
	warp_event  4, 27, ROUTE_55, 14
	warp_event  5, 27, ROUTE_55, 14
	warp_event 21, 23, WAREHOUSE_ENTRANCE, 1
	warp_event 20, 27, ROUTE_55, 13
	warp_event 21, 27, ROUTE_55, 13
	...
	object_event  9, 12, SPRITE_BURGLAR, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 2, GenericTrainerBurglarDuncan, EVENT_SALT_LAKE_VALLEY_ROCKET_TAKEOVER
	object_event  4,  8, SPRITE_BURGLAR, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 2, GenericTrainerBurglarOrson, EVENT_SALT_LAKE_VALLEY_ROCKET_TAKEOVER
	object_event 17,  2, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 3, GenericTrainerGruntM13, EVENT_SALT_LAKE_VALLEY_ROCKET_TAKEOVER
	object_event 11,  2, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 3, GenericTrainerGruntM11, EVENT_SALT_LAKE_VALLEY_ROCKET_TAKEOVER
	object_event  3,  2, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 3, GenericTrainerGruntM25, EVENT_SALT_LAKE_VALLEY_ROCKET_TAKEOVER
	object_event 19, 12, SPRITE_ROCKET_GIRL, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 1, GenericTrainerGruntF3, EVENT_SALT_LAKE_VALLEY_ROCKET_TAKEOVER
...
UndergroundSilverBattleScript:
	checkevent EVENT_RIVAL_PARK_CITY
	iftrue .Continue
	setevent EVENT_RIVAL_PARK_CITY
	setmapscene PARK_CITY_1F, 1
.Continue:
