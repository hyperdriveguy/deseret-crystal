TinTower1F_MapScriptHeader:
	...
	def_warp_events
	warp_event  7, 15, GREAT_SALT_LAKE, 3
	warp_event  8, 15, GREAT_SALT_LAKE, 3
	warp_event  8,  2, ROUTE_I80_WEST_2F, 2
	...
	def_object_events
	object_event  7,  9, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, SUICUNE, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_ROUTE_I80_WEST_1F_SUICUNE
	object_event  5,  9, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, RAIKOU, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_ROUTE_I80_WEST_1F_RAIKOU
	object_event 10,  9, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, ENTEI, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_ROUTE_I80_WEST_1F_ENTEI
	object_event  6,  3, SPRITE_EUSINE, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, TinTowerEusineHoOhText, EVENT_ROUTE_I80_WEST_1F_EUSINE
	object_event  3,  9, SPRITE_ELDER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, TinTower1FSage1Text, EVENT_ROUTE_I80_WEST_1F_WISE_TRIO_1
	object_event  9, 11, SPRITE_ELDER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, TinTower1FSage2Text, EVENT_ROUTE_I80_WEST_1F_WISE_TRIO_1
	object_event 12,  6, SPRITE_ELDER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, TinTower1FSage3Text, EVENT_ROUTE_I80_WEST_1F_WISE_TRIO_1
	object_event  2,  2, SPRITE_ELDER, SPRITEMOVEDATA_WALK_UP_DOWN, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, TinTower1FSage4Script, EVENT_ROUTE_I80_WEST_1F_WISE_TRIO_2
	object_event  7,  1, SPRITE_ELDER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, TinTower1FSage5Script, EVENT_ROUTE_I80_WEST_1F_WISE_TRIO_2
	object_event 12,  2, SPRITE_ELDER, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 0, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, TinTower1FSage6Script, EVENT_ROUTE_I80_WEST_1F_WISE_TRIO_2
...
UnknownScript_0x18502f:
	...
	iffalse UnknownScript_0x185050
	clearevent EVENT_ROUTE_I80_WEST_1F_WISE_TRIO_2
	setevent EVENT_ROUTE_I80_WEST_1F_WISE_TRIO_1
...
UnknownScript_0x185077:
	...
	disappear TINTOWER1F_RAIKOU
	disappear TINTOWER1F_ENTEI
	clearevent EVENT_ROUTE_I80_WEST_1F_WISE_TRIO_1
	setevent EVENT_ROUTE_I80_WEST_1F_WISE_TRIO_2
	endcallback
...
.Next2:
	...
	setevent EVENT_SAW_SUICUNE_ON_SALT_LAKE_CITY
	setmapscene SALT_LAKE_CITY, $0
	setevent EVENT_SAW_SUICUNE_AT_ROUTE_US89
	setmapscene ROUTE_US89, $0
	setscene $1
