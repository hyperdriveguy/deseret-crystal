...
; Johto story events
	...
	const EVENT_GOT_HEAT_ROCK_FROM_SALT_LAKE_VALLEY
	...
	const EVENT_GOT_KINGS_ROCK_IN_VERNAL_CITY
	...
	const EVENT_GOT_AIR_BALLOON_FROM_BYU_UNDERGROUND_LEADER
	const EVENT_GOT_MIRACLE_SEED_FROM_TIMPANOGOS_PASS_LEADER
	const EVENT_INTRODUCED_ROUTE_LEADERS
	const EVENT_GOT_BIG_NUGGET_FROM_ROUTE_191_LEADER
	const EVENT_GOT_BINDING_BAND_FROM_SALT_LAKE_CITY_LEADER
	const EVENT_GOT_PP_MAX_FROM_JORDANELLE_PASS_LEADER
	const EVENT_GOT_PROTECT_PADS_FROM_MOUNT_TIMPANOGOS_LEADER
...
; Johto hidden items
	const EVENT_ROUTE_I80_WEST_4F_HIDDEN_MAX_POTION
	const EVENT_ROUTE_I80_WEST_5F_HIDDEN_FULL_RESTORE
	const EVENT_ROUTE_I80_WEST_5F_HIDDEN_CARBOS
	const EVENT_PARK_CITY_1F_HIDDEN_ETHER
	const EVENT_PARK_CITY_1F_HIDDEN_ULTRA_BALL
	const EVENT_WENDOVER_CITY_HIDDEN_FULL_HEAL
	const EVENT_OLIVINE_MOUNT_TIMPANOGOS_5F_HIDDEN_HYPER_POTION
	const EVENT_TEAM_ROCKET_BASE_B1F_HIDDEN_REVIVE
	const EVENT_TEAM_ROCKET_BASE_B2F_HIDDEN_FULL_HEAL
	const EVENT_ROUTE_US40_1F_HIDDEN_GREAT_BALL
	const EVENT_ROUTE_US40_1F_HIDDEN_BIG_PEARL
	const EVENT_ROUTE_US40_1F_HIDDEN_PARALYZEHEAL
	const EVENT_ROUTE_US40_B1F_NORTH_HIDDEN_X_SPEED
	const EVENT_ROUTE_US40_B1F_NORTH_HIDDEN_REVIVE
	const EVENT_ROUTE_US40_B1F_SOUTH_DUSK_STONE
	const EVENT_ROUTE_US40_B1F_SOUTH_SUPER_REPEL
	const EVENT_ROUTE_US40_B1F_SOUTH_LIGHT_CLAY
	const EVENT_ROUTE_US40_B1F_SOUTH_HIDDEN_X_SPCL_DEF
	const EVENT_ROUTE_US40_B1F_SOUTH_HIDDEN_NUGGET
	const EVENT_ROUTE_US40_B1F_SOUTH_HIDDEN_FULL_RESTORE
	const EVENT_EXCAVATION_SITE_HIDDEN_ETHER
	const EVENT_EXCAVATION_SITE_HIDDEN_SUPER_POTION
	const EVENT_EXCAVATION_SITE_HIDDEN_FULL_HEAL
	const EVENT_EXCAVATION_SITE_HIDDEN_SILVER_LEAF_1
	const EVENT_EXCAVATION_SITE_HIDDEN_SILVER_LEAF_2
	...
	const EVENT_PROVO_CANYON_OUTSIDE_HIDDEN_RARE_CANDY
	...
	const EVENT_MTC_CAMPUS_HIDDEN_POTION
	const EVENT_TIMPANOGOS_PASS_HIDDEN_GREAT_BALL_1
	const EVENT_TIMPANOGOS_PASS_HIDDEN_SUPER_POTION_1
	const EVENT_HEBER_CITY_HIDDEN_HYPER_POTION
	const EVENT_HEBER_CITY_HIDDEN_LEVEL_BALL
	const EVENT_ROUTE_191_HIDDEN_RARE_CANDY
	const EVENT_ROUTE_191_HIDDEN_SUPER_POTION
	const EVENT_SALT_FLATS_HIDDEN_STAR_PIECE
	const EVENT_TEMPLE_SQUARE_HIDDEN_ETHER
	const EVENT_JORDANELLE_PASS_HIDDEN_NUGGET
	const EVENT_TIMPANOGOS_CAVE_HIDDEN_HYPER_POTION
	const EVENT_UNION_STATION_HIDDEN_MAX_ETHER
	const EVENT_ROUTE_42_HIDDEN_MAX_POTION
	const EVENT_ROUTE_44_HIDDEN_ELIXIR
	const EVENT_ROUTE_45_HIDDEN_PP_UP
	const EVENT_NEPHI_CITY_HIDDEN_POTION
	const EVENT_UTAH_LAKE_HIDDEN_POKE_BALL
	const EVENT_UTAH_LAKE_HIDDEN_HYPER_POTION
	const EVENT_ROUTE_87_HIDDEN_FULL_HEAL
	const EVENT_ANTELOPE_ISLAND_HIDDEN_HYPER_POTION
	const EVENT_UTAH_POINT_HIDDEN_RARE_CANDY
	const EVENT_UTAH_POINT_HIDDEN_BIG_PEARL
	const EVENT_UTAH_POINT_HIDDEN_SOFT_SAND
	const EVENT_ROUTE_US89_HIDDEN_REVIVE
	const EVENT_ROUTE_US89_HIDDEN_MAX_ETHER
	...
	const EVENT_BEAR_LAKE_HIDDEN_ULTRA_BALL
	const EVENT_LOGAN_CITY_HIDDEN_BIG_PEARL
	const EVENT_BEAR_LAKE_PASS_HIDDEN_PEARL
	const EVENT_BEAR_LAKE_PASS_HIDDEN_STARDUST
	const EVENT_MILLCREEK_CANYON_HIDDEN_REVIVE
	const EVENT_CARBON_ROAD_HIDDEN_STARDUST
	const EVENT_PRICE_CITY_HIDDEN_MULCH
	const EVENT_PRICE_CITY_HIDDEN_X_SPCL_DEF
	const EVENT_PRICE_CITY_HIDDEN_BIG_MUSHROOM
	const EVENT_PRICE_CITY_HIDDEN_TINYMUSHROOM
...
; Crystal-exclusive events in Johto
	...
	const EVENT_VALERIE_ANTELOPE_ISLAND
	const EVENT_VALERIE_GREAT_SALT_LAKE
	...
	const EVENT_GOT_FULL_RESTORE_FROM_MOUNT_TIMPANOGOS
...
; More Johto story events
	const EVENT_WARPED_FROM_TOOLE_CITY_WENDOVER_CITY_GATE
...
; More Crystal-exclusive events in Johto
	...
	const EVENT_DOOR_OPENED_IN_PROVO_CANYON
	const EVENT_ROUTE_67_OPEN
	const EVENT_ROUTE_67_CLOSED
	...
	const EVENT_HOLE_IN_PARK_CITY
	const EVENT_KOJI_ALLOWS_YOU_PASSAGE_TO_ROUTE_I80_WEST
...
; Johto itemballs
	...
	const EVENT_UTAH_LAKE_PP_UP
	const EVENT_UTAH_LAKE_RARE_CANDY
	const EVENT_LAKE_OF_RAGE_ELIXIR
	const EVENT_LAKE_OF_RAGE_MAX_REVIVE
	const EVENT_LAKE_OF_RAGE_TM_SUBSTITUTE
	const EVENT_OREM_CITY1F_PARALYZEHEAL
	const EVENT_OREM_CITY2F_X_ACCURACY
	const EVENT_OREM_CITY_3F_POTION
	const EVENT_OREM_CITY_3F_ESCAPE_ROPE
	const EVENT_ROUTE_I80_WEST_3F_FULL_HEAL
	const EVENT_ROUTE_I80_WEST_4F_ULTRA_BALL
	const EVENT_ROUTE_I80_WEST_4F_PP_UP
	const EVENT_ROUTE_I80_WEST_4F_ESCAPE_ROPE
	const EVENT_ROUTE_I80_WEST_5F_RARE_CANDY
	const EVENT_ROUTE_I80_WEST_7F_MAX_REVIVE
	const EVENT_ROUTE_I80_WEST_8F_BIG_NUGGET
	const EVENT_ROUTE_I80_WEST_8F_MAX_ELIXIR
	const EVENT_ROUTE_I80_WEST_8F_FULL_RESTORE
	const EVENT_TEAM_ROCKET_BASE_B3F_ULTRA_BALL
	const EVENT_UNDERGROUND_WAREHOUSE_ULTRA_BALL
	const EVENT_PARK_CITY_1F_HP_UP
	const EVENT_PARK_CITY_B1F_TM_FLAME_CHARGE
	const EVENT_WENDOVER_CITY_SHINY_STONE
	const EVENT_WENDOVER_CITY_TM_DIG
	const EVENT_ROUTE_US40_1F_GREAT_BALL
	const EVENT_ROUTE_US40_1F_X_ATTACK
	const EVENT_ROUTE_US40_1F_POTION
	const EVENT_ROUTE_US40_1F_AWAKENING
	const EVENT_ROUTE_US40_B1F_NORTH_TM_SWIFT
	const EVENT_ROUTE_US40_B1F_NORTH_X_DEFEND
	const EVENT_ROUTE_US40_B2F_ELIXIR
	const EVENT_ROUTE_US40_B2F_HYPER_POTION
	const EVENT_VERNAL_CITY_B1F_SUPER_POTION
	const EVENT_VERNAL_CITY_B2F_DAMP_ROCK
	const EVENT_OLIVINE_MOUNT_TIMPANOGOS_3F_ETHER
	const EVENT_OLIVINE_MOUNT_TIMPANOGOS_5F_RARE_CANDY
	const EVENT_OLIVINE_MOUNT_TIMPANOGOS_5F_SUPER_REPEL
	const EVENT_OLIVINE_MOUNT_TIMPANOGOS_5F_TM_ENERGY_BALL
	const EVENT_OLIVINE_MOUNT_TIMPANOGOS_6F_SUPER_POTION
	const EVENT_OLIVINE_MOUNT_TIMPANOGOS_ROOF_SILVER_LEAF
	...
	const EVENT_EXCAVATION_SITE_REVIVE
	...
	const EVENT_ROUTE_I15_POTION
	const EVENT_BYU_UNDERGROUND_POTION
	const EVENT_BYU_UNDERGROUND_POKE_BALL
	const EVENT_TIMPANOGOS_PASS_GREAT_BALL
	const EVENT_TIMPANOGOS_PASS_REPEL
	const EVENT_HEBER_CITY_SOFT_SAND
	const EVENT_HEBER_CITY_WHITE_HERB
	const EVENT_CARBON_POWER_PLANT_PEARL_STRING
	const EVENT_TOOLE_CITY_TM_HONE_CLAWS
	const EVENT_SALT_FLATS_BIG_PEARL
	const EVENT_JORDANELLE_PASS_TM_BULLDOZE
	...
	const EVENT_BEAR_LAKE_PASS_REVIVE
	const EVENT_BEAR_LAKE_PASS_MYSTIC_WATER
	const EVENT_BEAR_LAKE_PASS_QUICK_CLAW
	const EVENT_BEAR_LAKE_PASS_MAX_REPEL
	...
	const EVENT_BYU_CAMPUS_SHINY_STONE
	const EVENT_MILLCREEK_CANYON_STAR_PIECE
	const EVENT_CARBON_ROAD_ZINC
	const EVENT_PRICE_CITY_FULL_HEAL
	const EVENT_PRICE_CITY_BIG_MUSHROOM
	const EVENT_PRICE_CITY_TOXIC_ORB
	const EVENT_PRICE_CITY_MULCH
; Johto people
	const EVENT_TEACHER_NEPHI_CITY
	const EVENT_LYRA_NEPHI_CITY
	const EVENT_LYRA_ROUTE_I15
	const EVENT_LYRA_TIMPANOGOS_PASS
	const EVENT_LYRA_ROUTE_191
	const EVENT_LYRA_DAYCARE
	const EVENT_LYRA_ROUTE_42
	const EVENT_GRANDPA_ROUTE_191
	const EVENT_RIVAL_NEPHI_CITY
	const EVENT_RIVAL_PROVO_CITY
	const EVENT_RIVAL_ROUTE_87
	const EVENT_RIVAL_TEAM_ROCKET_BASE
	const EVENT_RIVAL_UNDERGROUND_PATH
	const EVENT_RIVAL_VICTORY_ROAD
	const EVENT_RIVAL_UTAH_POINT
	const EVENT_RIVAL_OREM_CITY
	const EVENT_RIVAL_PARK_CITY
	...
	const EVENT_UTAH_LAKE_EARL
	const EVENT_EARLS_ACADEMY_EARL
	const EVENT_VIOLET_GYM_FALKNER
	const EVENT_GOLDENROD_GYM_WHITNEY
	const EVENT_ROUTE_55_ROCKET_SCOUT
	const EVENT_ROUTE_55_ROCKET_TAKEOVER
	const EVENT_SALT_LAKE_VALLEY_ROCKET_TAKEOVER
	const EVENT_ROUTE_55_CIVILIANS
	const EVENT_SALT_LAKE_VALLEY_CIVILIANS_AFTER
	const EVENT_SALT_LAKE_VALLEY_BLACKBELT_BLOCKS_STAIRS
	const EVENT_SALT_LAKE_VALLEY_DIRECTOR
	const EVENT_SALT_LAKE_VALLEY_PETREL
	const EVENT_OLIVINE_MOUNT_TIMPANOGOS_JASMINE
	...
	const EVENT_DAYCARE_MAN_ON_ROUTE_191
	const EVENT_DAYCARE_MON_1
	const EVENT_DAYCARE_MON_2
	const EVENT_EXCAVATION_SITE_FARFETCHD
	const EVENT_ROUTE_191_EXCAVATION_SITE_GATE_TEACHER_BEHIND_COUNTER
	const EVENT_ROUTE_191_EXCAVATION_SITE_GATE_LASS
	const EVENT_ROUTE_191_EXCAVATION_SITE_GATE_TEACHER_IN_WALKWAY
	const EVENT_EXCAVATION_SITE_LASS
	const EVENT_EXCAVATION_SITE_LYRA
	const EVENT_EXCAVATION_SITE_CELEBI
	const EVENT_COPYCAT_1
	const EVENT_COPYCAT_2
	const EVENT_GOLDENROD_SALE_OFF
	const EVENT_GOLDENROD_SALE_ON
	const EVENT_EXCAVATION_SITE_APPRENTICE
	const EVENT_EXCAVATION_SITE_CHARCOAL_MASTER
	const EVENT_CHARCOAL_KILN_FARFETCH_D
	const EVENT_CHARCOAL_KILN_APPRENTICE
	const EVENT_CHARCOAL_KILN_BOSS
	const EVENT_SALT_LAKE_CITY_SUDOWOODO
	const EVENT_ROUTE_87_SLOWPOKES
	const EVENT_ROUTE_87_SLOWPOKETAIL_ROCKET
	const EVENT_VERNAL_CITY_SLOWPOKES
	const EVENT_VERNAL_CITY_ROCKETS
	...
	const EVENT_PROVO_CANYON_OUTSIDE_SCIENTIST
	const EVENT_PROVO_CANYON_OUTSIDE_SCIENTIST_CLIMAX
	const EVENT_PROVO_CANYON_RESEARCH_CENTER_SCIENTIST
	const EVENT_PROVO_CANYON_INNER_CHAMBER_TOURISTS
	...
	const EVENT_ROUTE_I80_EAST_LODESTONE_1
	const EVENT_ROUTE_I80_EAST_LODESTONE_2
	const EVENT_ROUTE_I80_EAST_LODESTONE_3
	const EVENT_ROUTE_I80_EAST_LODESTONE_4
	const EVENT_NEVER_MET_BILL
	const EVENT_ECRUTEAK_POKE_CENTER_BILL
	const EVENT_MTC_CAMPUS_BATTLE
	const EVENT_MTC_CAMPUS_YOUNGSTER_JOEY
	...
	const EVENT_TOOLE_CITY_WENDOVER_CITY_GATE_BUG_MANIAC
	...
	const EVENT_TOOLE_CITY_WENDOVER_CITY_GATE_OFFICER_CONTEST_DAY
	const EVENT_TOOLE_CITY_WENDOVER_CITY_GATE_OFFICER_NOT_CONTEST_DAY
	const EVENT_SALT_LAKE_CITY_WENDOVER_CITY_GATE_OFFICER_CONTEST_DAY
	const EVENT_SALT_LAKE_CITY_WENDOVER_CITY_GATE_OFFICER_NOT_CONTEST_DAY
	const EVENT_GOLDENROD_TRAIN_STATION_GENTLEMAN
	const EVENT_PARK_CITY_B1F_BEASTS_1
	const EVENT_PARK_CITY_B1F_BEASTS_2
	const EVENT_BLACKTHORN_CITY_GRAMPS_BLOCKS_DRAGONS_DEN
	const EVENT_BLACKTHORN_CITY_GRAMPS_NOT_BLOCKING_DRAGONS_DEN
	const EVENT_PROVO_CANYON_KABUTO_CHAMBER_RECEPTIONIST
	...
	const EVENT_TIMPANOGOS_PASS_FRIEDA_OF_FRIDAY
	const EVENT_ROUTE_I15_TUSCANY_OF_TUESDAY
	const EVENT_SALT_LAKE_CITY_ARTHUR_OF_THURSDAY
	const EVENT_TEMPLE_SQUARE_SUNNY_OF_SUNDAY
	const EVENT_LAKE_OF_RAGE_WESLEY_OF_WEDNESDAY
	const EVENT_BLACKTHORN_CITY_SANTOS_OF_SATURDAY
	const EVENT_TIMPANOGOS_CAVE_MONICA_OF_MONDAY
	const EVENT_LANCES_ROOM_OAK_AND_MARY
	const EVENT_ROUTE_US40_B2F_LAPRAS
	const EVENT_TEAM_ROCKET_DISBANDED
	const EVENT_GOLDENROD_DEPT_STORE_5F_HAPPINESS_EVENT_LADY
	const EVENT_PARK_CITY_MORTY
	const EVENT_PARK_CITY_1F_EUSINE
	...
	const EVENT_ROUTE_55_MOVE_TUTOR
...
; Kanto people
	...
	const EVENT_LAV_SALT_LAKE_VALLEY_POPULATION
	...
	const EVENT_ROUTE_67_CHERYL
	const EVENT_ROUTE_67_RILEY
	const EVENT_ROUTE_67_BUCK
	const EVENT_ROUTE_67_MARLEY
	const EVENT_ROUTE_67_MIRA
	const EVENT_ROUTE_67_ANABEL
; Orange itemball
...
; New to Crystal
	...
	const EVENT_PROVO_CANYON_OUTSIDE_TOURIST_FISHER
	const EVENT_PROVO_CANYON_OUTSIDE_TOURIST_YOUNGSTERS
	const EVENT_DRAGON_SHRINE_CLAIR
	const EVENT_ROUTE_67_BATTLE_ROOM_YOUNGSTER
	...
	const EVENT_ROUTE_87_KURT
	const EVENT_EXCAVATION_SITE_KURT
	const EVENT_MOUNT_MORTAR_1F_INSIDE_MAX_POTION
	const EVENT_MOUNT_MORTAR_1F_INSIDE_NUGGET
	const EVENT_ECRUTEAK_GYM_GRAMPS
	const EVENT_ANTELOPE_ISLAND_GRAMPS
	const EVENT_EUSINE_IN_PARK_CITY
	const EVENT_WISE_TRIOS_ROOM_WISE_TRIO_1
	const EVENT_WISE_TRIOS_ROOM_WISE_TRIO_2
	const EVENT_ROUTE_US89_EUSINE
	const EVENT_SAW_SUICUNE_AT_ROUTE_US89
	const EVENT_SAW_SUICUNE_ON_ROUTE_42
	const EVENT_SAW_SUICUNE_ON_SALT_LAKE_CITY
	const EVENT_ECRUTEAK_HOUSE_WANDERING_SAGE
	const EVENT_ROUTE_I80_WEST_1F_SUICUNE
	const EVENT_ROUTE_I80_WEST_1F_ENTEI
	const EVENT_ROUTE_I80_WEST_1F_RAIKOU
	const EVENT_ROUTE_I80_WEST_1F_EUSINE
	const EVENT_ROUTE_I80_WEST_1F_WISE_TRIO_1
	const EVENT_SET_WHEN_FOUGHT_HO_OH
	const EVENT_MTC_CAMPUS_ANTIDOTE
	const EVENT_EXCAVATION_SITE_X_ATTACK
	const EVENT_EXCAVATION_SITE_ANTIDOTE
	const EVENT_EXCAVATION_SITE_MULCH
	const EVENT_ROUTE_191_NUGGET
	...
	const EVENT_ROUTE_I80_WEST_1F_WISE_TRIO_2
	const EVENT_ROUTE_I80_WEST_6F_MAX_POTION
	const EVENT_ROUTE_I80_WEST_9F_HP_UP
	...
	const EVENT_SALT_LAKE_VALLEY_5F_ULTRA_BALL
	...
	const EVENT_DO_PROVO_CANYON_CLIMAX
	const EVENT_PROVO_CANYON_CLIMAX_DONE
	const EVENT_ROUTE_I80_EAST_LODESTONE_IN_PIT
	...
	const EVENT_EXORCISED_LAV_SALT_LAKE_VALLEY
...
; Cut trees
	...
	const EVENT_ROUTE_I15_CUT_TREE_1
	const EVENT_ROUTE_I15_CUT_TREE_2
	const EVENT_MTC_CAMPUS_CUT_TREE
	const EVENT_BYU_UNDERGROUND_CUT_TREE_1
	const EVENT_BYU_UNDERGROUND_CUT_TREE_2
	const EVENT_TIMPANOGOS_PASS_CUT_TREE
	const EVENT_TOOLE_CITY_CUT_TREE
	...
	const EVENT_PRICE_CITY_CUT_TREE_1
	const EVENT_PRICE_CITY_CUT_TREE_2
	...
	const EVENT_ROUTE_I80_EAST_EAST_CUT_TREE
	const EVENT_BYU_CAMPUS_CUT_TREE
; TODO: reorganize these when it's okay to break saves
	const EVENT_JUDGE_MACHINE_ENGINEER
	const EVENT_BRED_AN_EGG
	const EVENT_HEBER_CITY_HIDDEN_ELIXIR
	const EVENT_VERNAL_CITY_ENTRANCE_HIDDEN_SUPER_POTION
	const EVENT_ROUTE_67_INTRO
	const EVENT_BATTLE_FACTORY_INTRO
	const EVENT_TALKED_TO_MR_HYPER
	const EVENT_DECO_POSTER_4
	const EVENT_PROVO_CITY_HIDDEN_NUGGET
	const EVENT_TIMPANOGOS_PASS_HIDDEN_GREAT_BALL_2
	const EVENT_TIMPANOGOS_PASS_HIDDEN_SUPER_POTION_2
	const EVENT_TIMPANOGOS_PASS_HIDDEN_GOLD_LEAF
	const EVENT_TOOLE_CITY_HIDDEN_NUGGET
	const EVENT_ROUTE_US40_B2F_HIDDEN_CALCIUM
	const EVENT_ROUTE_US40_B2F_HIDDEN_ULTRA_BALL
	const EVENT_ANTELOPE_ISLAND_HIDDEN_RARE_CANDY
	const EVENT_ANTELOPE_ISLAND_HIDDEN_ULTRA_BALL
	const EVENT_ANTELOPE_ISLAND_HIDDEN_ETHER
