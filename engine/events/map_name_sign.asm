...
.CheckExcludedMap:
	ld a, [wMapGroup]
	assert GROUP_TOOLE_CITY_WENDOVER_CITY_GATE == GROUP_SALT_LAKE_CITY_WENDOVER_CITY_GATE
	cp GROUP_TOOLE_CITY_WENDOVER_CITY_GATE
	jr nz, .not_national_park_gate
	ld a, [wMapNumber]
	cp MAP_TOOLE_CITY_WENDOVER_CITY_GATE
	ret z
	cp MAP_SALT_LAKE_CITY_WENDOVER_CITY_GATE
	ret
