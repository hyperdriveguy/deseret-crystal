...
BugContestResultsWarpScript:
	...
	setevent EVENT_SALT_LAKE_CITY_WENDOVER_CITY_GATE_OFFICER_CONTEST_DAY
	clearevent EVENT_SALT_LAKE_CITY_WENDOVER_CITY_GATE_OFFICER_NOT_CONTEST_DAY
	setevent EVENT_WARPED_FROM_TOOLE_CITY_WENDOVER_CITY_GATE
	warp SALT_LAKE_CITY_WENDOVER_CITY_GATE, $0, $4
	applymovement PLAYER, Movement_ContestResults_WalkAfterWarp
	; fallthrough

BugContestResultsScript:
	clearflag ENGINE_BUG_CONTEST_TIMER
	clearevent EVENT_WARPED_FROM_TOOLE_CITY_WENDOVER_CITY_GATE
...
.CleanUp
	closetext
	setscene $0
	setmapscene TOOLE_CITY_WENDOVER_CITY_GATE, $0
